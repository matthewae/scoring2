                        ...
                        <li>Status pengajuan akan ditampilkan dengan indikator warna:
                            <div class="mt-2 space-y-2">
                                <div class="flex items-center">
                                    ...
                                    <span>Active - Dokumen baru diajukan dan menunggu review</span>
                                </div>
                                <div class="flex items-center">
                                    <span class="w-3 h-3 bg-blue-500 rounded-full mr-2"></span>
                                    <span>In Progress - Dokumen sedang dalam proses penilaian</span>
                                </div>
                                <div class="flex items-center">
                                    <span class="w-3 h-3 bg-orange-500 rounded-full mr-2"></span>
                                    <span>On Hold - Dokumen memerlukan revisi atau klarifikasi</span>
                                </div>
                                <div class="flex items-center">
                                    <span class="w-3 h-3 bg-green-500 rounded-full mr-2"></span>
                                    <span>Complete - Penilaian telah selesai</span>
                                </div>
                                <div class="flex items-center">
                                    <span class="w-3 h-3 bg-red-500 rounded-full mr-2"></span>
                                    <span>Revision - Dokumen perlu diperbaiki sesuai catatan</span>
                                </div>
                            </div>
                        </li>
                    </ul>
